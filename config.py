...
dev_addr = struct.unpack(">l", ubinascii.unhexlify('26011B2D'))[0]            #parametres ABP 26011B2D nok
nwk_swkey = ubinascii.unhexlify('804867C0AC8F1FA302537D48FADAFA6E')#(0xA3, 0xBE, 0x3D, 0x74, 0xAF, 0x21, 0x79, 0xFA, 0xB9, 0xE1, 0x1C, 0xFE, 0x07, 0xC5, 0x46, 0x87)# nok A3BE3D74AF2179FAB9E11CFE07C54687
app_swkey = ubinascii.unhexlify('FECE29BF4B5C94C74805EACDC1B69597')#(0x83, 0x74, 0xD4, 0x71, 0x09, 0x60, 0xE6, 0x42, 0x1B, 0xDC, 0xF1, 0x5F, 0x63, 0x9E, 0x84, 0x11)#nok 8374D4710960E6421BDCF15F639E8411
